...
1. Usa filter() para obtener los productos que cuesten menos de $100.

2. Usa sort() para ordenar esos productos alfabéticamente por su nombre.

3. Usa map() para generar un nuevo arreglo que contenga solo los nombres de los productos.
Muestra los resultados de la aplicación de cada métiodo en consola.

4. (Opcional) Incluye alguno de los métodos faltantes (reduce, some, every, includes, etc.) con algún caso de uso en este ejemplo, usa tu creatividad.
